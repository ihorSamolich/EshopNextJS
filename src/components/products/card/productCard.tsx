...
const ProductCard = ({ id, name, price, discount, photos }: IProduct) => {
	return (
		<Link href={`/products/${id}`}>
			<div className='min-h-full w-72 sm:w-auto sm:max-w-72 group relative p-5 rounded-xl border-2 border-violet-200 transition duration-500 ease-in-out transform hover:border-violet-600'>
